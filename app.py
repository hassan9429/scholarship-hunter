...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-KZ6LXW693R"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-KZ6LXW693R');
</script>
...
def build_database():
    ...
    T = [
        ...
        # ══ USA UNIVERSITIES WITH GRA/GTA ══
        dict(name="University of Vermont Graduate Assistant Funding", country="USA (Vermont)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Environmental Science","Data Science","Food Science"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.5, toefl_min=90,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $18,000-22,000/year (GRA/GTA stipend) + health insurance",
             dm=1, dd=15, om=10, od=1,
             apply_link="https://www.uvm.edu/graduate/admissions",
             portal="https://www.uvm.edu/",
             notes="RTP-TYPE. HIDDEN GEM. Vermont's top research university. Email department professors directly about GRA/GTA positions. Rolling admissions."),
        dict(name="Kansas State University Graduate Teaching Assistantship", country="USA (Kansas)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Agricultural Science","Food Science","Engineering"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $16,000-20,000/year (GTA stipend) + health insurance",
             dm=2, dd=1, om=11, od=1,
             apply_link="https://www.k-state.edu/graduate/",
             portal="https://www.k-state.edu/",
             notes="RTP-TYPE. HIDDEN. Kansas's flagship. Agriculture & Engineering strong. GTA positions abundant. Contact departments directly."),
        dict(name="University of Nebraska-Lincoln Graduate Research Assistantship", country="USA (Nebraska)", region="North America", schengen=False,
             fields=["Biotechnology","Agricultural Science","Civil Engineering","Computer Science","Food Science","Environmental"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=79,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $17,000-21,000/year (GRA stipend) + health insurance",
             dm=3, dd=15, om=12, od=1,
             apply_link="https://admissions.unl.edu/graduate",
             portal="https://www.unl.edu/",
             notes="RTP-TYPE. HIDDEN GEM. Nebraska's premier research university. Agriculture & Food Science world-class. GRA funding abundant."),
        dict(name="Illinois State University Graduate Assistantship Program", country="USA (Illinois)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Engineering","Environmental Science","Food Science","Data Science"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $16,000-19,000/year (GA stipend) + health insurance",
             dm=2, dd=1, om=11, od=1,
             apply_link="https://graduate.illinoisstate.edu/admissions/",
             portal="https://www.illinoisstate.edu/",
             notes="RTP-TYPE. HIDDEN. Illinois State's strong graduate program. GA positions available across departments. Email professors."),
        dict(name="University of Oklahoma Graduate Research/Teaching Assistantship", country="USA (Oklahoma)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Food Science","Energy","Environmental Science"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $17,000-20,000/year (GRA/GTA stipend) + health insurance",
             dm=2, dd=15, om=11, od=1,
             apply_link="https://www.ou.edu/admissions/graduate",
             portal="https://www.ou.edu/",
             notes="RTP-TYPE. HIDDEN. Oklahoma's flagship. Energy research strong. GRA/GTA widely available. Contact department heads."),
        dict(name="University of South Florida Graduate Research Assistantship", country="USA (Florida)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Food Science","Environmental Science","Engineering"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $15,000-19,000/year (GRA stipend) + health insurance",
             dm=3, dd=1, om=12, od=1,
             apply_link="https://www.usf.edu/graduate/admissions/",
             portal="https://www.usf.edu/",
             notes="RTP-TYPE. HIDDEN GEM. USF Tampa Bay's growing research hub. GRA funding increasing. Affordable cost of living."),
        dict(name="University of Arizona Graduate Research/Teaching Assistantship", country="USA (Arizona)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Food Science","Agricultural Science","Environmental"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $16,000-21,000/year (GRA/GTA stipend) + health insurance",
             dm=1, dd=15, om=11, od=1,
             apply_link="https://grad.arizona.edu/admissions",
             portal="https://www.arizona.edu/",
             notes="RTP-TYPE. HIDDEN. Arizona's top research university. Agriculture excellent. Many GRA/GTA positions. Email professors directly."),
        dict(name="Michigan State University Graduate Research/Teaching Assistantship", country="USA (Michigan)", region="North America", schengen=False,
             fields=["Biotechnology","Food Science","Agricultural Science","Computer Science","Civil Engineering","Environmental"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=79,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $17,000-21,000/year (GRA/GTA stipend) + health insurance",
             dm=2, dd=1, om=12, od=1,
             apply_link="https://grad.msu.edu/admissions",
             portal="https://www.msu.edu/",
             notes="RTP-TYPE. HIDDEN GEM. Michigan State's world-class Agriculture & Food Science. GRA funding abundant. Contact departments early."),
        dict(name="Purdue University Graduate Research/Teaching Assistantship", country="USA (Indiana)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Food Science","Agricultural Engineering","Energy"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=6.0, toefl_min=80,
             fully_funded=True, hidden=False, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $17,500-22,000/year (GRA/GTA stipend) + health insurance",
             dm=1, dd=15, om=11, od=1,
             apply_link="https://www.purdue.edu/gradschool/",
             portal="https://www.purdue.edu/",
             notes="RTP-TYPE. Purdue's strong engineering & agriculture. Many GRA positions. Good cost-of-living ratio. Contact advisors."),
        dict(name="Texas A&M University-Commerce Graduate Assistantship", country="USA (Texas)", region="North America", schengen=False,
             fields=["Biotechnology","Computer Science","Civil Engineering","Food Science","Agricultural Science","Engineering"],
             program_type="Research", degree_level=["MS","PhD"],
             language_req=["IELTS","TOEFL"], ielts_min=5.5, toefl_min=72,
             fully_funded=True, hidden=True, hec_route=False, ielts_waiver=False, rtp=True,
             coverage="Full tuition + $14,000-18,000/year (GA stipend) + health insurance",
             dm=3, dd=1, om=12, od=1,
             apply_link="https://www.tamuc.edu/admissions/graduate/",
             portal="https://www.tamuc.edu/",
             notes="RTP-TYPE. HIDDEN GEM. A&M Commerce's affordable graduate program. Lower IELTS (5.5) than others. GA funding available. Rolling admissions."),
        # ══ ASIA ══
